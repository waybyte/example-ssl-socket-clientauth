# Logicrom OpenCPU SDK - SSL socket example with client authentication
...
4. Download and Extract examples from github https://github.com/waybyte/example-ssl-socket-clientauth/archive/master.zip
